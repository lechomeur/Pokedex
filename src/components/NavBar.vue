    ...
    <div class="navbar-content">
      ...
      <div class="nav-center">
        <div class="nav-links">
          ...
          <router-link to="/team" class="nav-item">My Team</router-link>
          <router-link to="/about" class="nav-item">About</router-link>
        </div>
      </div>

      <div class="nav-right">
        <button @click="toggleDarkMode" class="theme-toggle" :title="isDark ? 'Light Mode' : 'Dark Mode'">
          <svg v-if="!isDark" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
...
const toggleDarkMode = () => {
  ...
  // Altera a classe no body para afetar o site todo (App.vue)
  if (isDark.value) {
